...
"[project]/frontend/app/play/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
                ...
                "PlayPage.useEffect": async ()=>{
                    ...
                    try {
                        ...
                        const filteredSpots = spots.filter({
                            "PlayPage.useEffect.filteredSpots": (spot)=>{
                        ...
                        }["PlayPage.useEffect.filteredSpots"]);
                        ...
                        window.localStorage.setItem('correctSpot', JSON.stringify(correctSpot));
                        // StreetView
                        const streetView = document.getElementById('streetView');
                        try {
                            const svRes = await fetch(`${window.location.origin}/api/streetview-url?lat=${correctSpot.lat}&lng=${correctSpot.lng}`);
                            ...
                            if (streetView) {
                                const textNode = document.createTextNode('📍 Street View を表示できません');
                    ...
                    function calcDistanceAndScore(lat1, lng1, lat2, lng2) {
                        const R = 6371;
                        const toRad = {
                            "PlayPage.useEffect.calcDistanceAndScore.toRad": (deg)=>deg * (Math.PI / 180)
                        }["PlayPage.useEffect.calcDistanceAndScore.toRad"];
                    ...
                    submitBtn.addEventListener('click', {
                        "PlayPage.useEffect": async ()=>{
                            ...
                            const { distanceKm, score } = calcDistanceAndScore(selectedLatLng.lat, selectedLatLng.lng, correctSpot.lat, correctSpot.lng);
                            const newEntry = {
                                id: Date.now(),
                            ...
                            // localStorage 履歴
                            try {
                                const old = JSON.parse(window.localStorage.getItem('history') || '[]');
                                old.push(newEntry);
                                window.localStorage.setItem('history', JSON.stringify(old));
                            } catch (err) {
                                console.warn('履歴保存失敗:', err);
                            }
                            window.localStorage.setItem('lastAnswerCoords', JSON.stringify(selectedLatLng));
                            window.localStorage.setItem('correctCoords', JSON.stringify({
                                lat: correctSpot.lat,
                                lng: correctSpot.lng
                            }));
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                id: "4d2e7200df3523d9",
                children: "html,body{color:#e0e0e0;background-color:#0e1a2b;height:100%;margin:0;padding:0;font-family:Orbitron,sans-serif;overflow:hidden}#navbar-placeholder{z-index:2000;height:60px;position:fixed;top:0;left:0;right:0}.streetview-wrapper{width:100%;height:calc(100% - 60px);margin:0;padding:0;position:absolute;inset:60px 0 0;overflow:hidden}.streetview-iframe{border:none;width:100%;height:100%;display:block}.map-overlay{z-index:1000;border-radius:12px;width:150px;height:125px;transition:all .3s;position:absolute;bottom:20px;right:20px;overflow:hidden;box-shadow:0 4px 16px #0006}.map-overlay:hover{width:300px;height:250px}#map{width:100%;height:100%}#submitAnswer{color:#fff;cursor:pointer;z-index:1001;background-color:#43a047;border:none;border-radius:10px;padding:12px 20px;font-size:16px;font-weight:700;transition:background .3s;position:absolute;top:20px;right:20px}#submitAnswer:hover{background-color:#388e3c}#submitAnswer:disabled{cursor:not-allowed;opacity:.7;background-color:#888}"
            }, void 0, false, void 0, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                id: "navbar-placeholder",
                className: "jsx-4d2e7200df3523d9"
            }, void 0, false, {
                fileName: "[project]/frontend/app/play/page.tsx",
                lineNumber: 333,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "jsx-4d2e7200df3523d9" + " " + "streetview-wrapper",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("iframe", {
                        ...
                        loading: "lazy",
                        className: "jsx-4d2e7200df3523d9" + " " + "streetview-iframe"
                    }, void 0, false, {
                        fileName: "[project]/frontend/app/play/page.tsx",
                        lineNumber: 336,
                        columnNumber: 9
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "jsx-4d2e7200df3523d9" + " " + "map-overlay",
...
_s(PlayPage, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = PlayPage;
var _c;
...
//# sourceMappingURL=frontend_099baeaf._.js.map