...
"[project]/frontend/app/addition/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdditionPage() {
    ...
    const streetviewRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const leftPanelRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const currentStreetViewUrlRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])('');
    const lastGeocodeQueryRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])('');
    const isComposingRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    // ==== 状態 ====
    ...
    const [genre, setGenre] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('historic');
    ...
    const [selectedImageFile, setSelectedImageFile] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [aiStatus, setAiStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [aiLoading, setAiLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // ==== CSS 注入 & テーマ / body クラス ====
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdditionPage.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdditionPage.useEffect": ()=>{
            const applyNavHeight = {
                "AdditionPage.useEffect.applyNavHeight": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdditionPage.useEffect": ()=>{
            ...
            if (!resizer) return;
            const savedPx = parseInt((("TURBOPACK compile-time truthy", 1) ? window.localStorage.getItem('leftSvHeightPx') : "TURBOPACK unreachable") || '', 10);
            ...
            let startH = 0;
            const getPanelRect = {
                "AdditionPage.useEffect.getPanelRect": ()=>panel.getBoundingClientRect()
            }["AdditionPage.useEffect.getPanelRect"];
            const applyHeight = {
                "AdditionPage.useEffect.applyHeight": (px)=>{
            ...
            }["AdditionPage.useEffect.applyHeight"];
            const onMove = {
                "AdditionPage.useEffect.onMove": (clientY)=>{
                    const delta = clientY - startY;
                    applyHeight(startH + delta);
                }
            }["AdditionPage.useEffect.onMove"];
            const onMouseMove = {
                "AdditionPage.useEffect.onMouseMove": (e)=>{
                    if (!dragging) return;
                    onMove(e.clientY);
                }
            }["AdditionPage.useEffect.onMouseMove"];
            const onMouseUp = {
                "AdditionPage.useEffect.onMouseUp": ()=>{
                    dragging = false;
                }
            }["AdditionPage.useEffect.onMouseUp"];
            const onTouchMove = {
                "AdditionPage.useEffect.onTouchMove": (e)=>{
                    if (!dragging) return;
                    const t = e.touches[0];
                    if (t) onMove(t.clientY);
                }
            }["AdditionPage.useEffect.onTouchMove"];
            const onTouchEnd = {
                "AdditionPage.useEffect.onTouchEnd": ()=>{
                    dragging = false;
                }
            }["AdditionPage.useEffect.onTouchEnd"];
            const onMouseDown = {
                "AdditionPage.useEffect.onMouseDown": (e)=>{
                    e.preventDefault();
                    dragging = true;
                    startY = e.clientY;
            ...
            }["AdditionPage.useEffect.onMouseDown"];
            const onTouchStart = {
                "AdditionPage.useEffect.onTouchStart": (e)=>{
                    const t = e.touches[0];
                    if (!t) return;
                    dragging = true;
                    startY = t.clientY;
            ...
            }["AdditionPage.useEffect.onTouchStart"];
            const onKeyDown = {
                "AdditionPage.useEffect.onKeyDown": (e)=>{
            ...
            }["AdditionPage.useEffect.onKeyDown"];
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    previewUrl && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                        id: "preview",
                                        src: previewUrl,
                                        alt: "プレビュー画像",
                                        style: {
                                    ...
                                    previewUrl && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        id: "deleteImage",
                                        type: "button",
                                        style: {
                                            display: 'block'
...
_s(AdditionPage, "L63+K8CSMcmnI31QoJdac8jOmxQ=", false, function() {
    return [
...
_c = AdditionPage;
var _c;
__turbopack_context__.k.register(_c, "AdditionPage");
...
//# sourceMappingURL=frontend_app_addition_page_tsx_6bdd9bc4._.js.map